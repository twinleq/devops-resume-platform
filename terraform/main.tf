...
terraform {
  ...
  backend "s3" {
    bucket = "devops-resume-terraform-state"
...
provider "aws" {
  ...
  default_tags {
    tags = {
      Project     = "devops-resume-platform"
...
resource "aws_s3_bucket" "terraform_state" {
  ...
  tags = merge(local.common_tags, {
    Name = "devops-resume-terraform-state"
  })
}
...
resource "aws_ecr_repository" "resume_app" {
  name                 = "devops-resume-platform"
